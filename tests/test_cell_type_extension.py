...
# The same as above, but with no annotation client
def test_cell_type_point_extension_no_annotation_client(img_layer, seg_layer, s1, s2):
    ...
    assert len(ct_ext.annotation_df) == 1
    print(manager.viewer.state.layers['cell_types'].annotations[0].description)
    assert re.search('valence:e$', manager.viewer.state.layers['cell_types'].annotations[0].description) != None
    ...
    assert len(ct_ext.annotation_df) == 1
    print(manager.viewer.state.layers['cell_types'].annotations[0].description)
    assert re.search('valence:i$', manager.viewer.state.layers['cell_types'].annotations[0].description) != None
    ...
    assert len(ct_ext.annotation_df) == 1
    print(manager.viewer.state.layers['cell_types'].annotations[0].description)
    assert re.search('ivscc_m:uncertain$', manager.viewer.state.layers['cell_types'].annotations[0].description) != None
