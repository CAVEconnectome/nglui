# parser.base.line_annotations { #nglui.parser.base.line_annotations }
...
| Type   | Description                                                                        |
|--------|------------------------------------------------------------------------------------|
| list   | List of N 3-element points (as list) of the first point in each line.              |
| list   | List of N 3-element points (as list) of the second point in each line.             |
