# statebuilder.helpers.make_point_statebuilder { #nglui.statebuilder.helpers.make_point_statebuilder }
...
| `point_column`       | str                   | Column in dataframe to pull points from. Defaults to "pt_position".                                                              | `'pt_position'` |
...
| `tag_column`         | str, optional)        | column to use for tags, None for no tags (default=None)                                                                          | `None`          |
